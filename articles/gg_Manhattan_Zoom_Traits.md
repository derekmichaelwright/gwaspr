...
mp <- gg_Manhattan_Zoom_Traits(
  ...
  chr = 5 ) 
# Save
ggsave("figures/gg_Manhattan_Zoom_Traits_01.png", 
       mp, width = 8, height = 6 )
```
...
# Save
ggsave("figures/gg_Manhattan_Zoom_Traits_02.png", 
       mp, width = 8, height = 6 )
```
...
mp <- gg_Manhattan_Zoom_Traits(
  ...
  # Create a title for the plot
  title = "Days To Flower",
  # Plot just Chromosome 5 (1000000 - 2500000)
  chr = 5, 
  pos1 = 1000000,
  pos2 = 2500000,
  # Set horizontal thresholds bars
  ...
  model.colors = gwaspr_Colors ) 
# Save
ggsave("figures/gg_Manhattan_Zoom_Traits_03.png", 
       mp, width = 8, height = 6 )
```
