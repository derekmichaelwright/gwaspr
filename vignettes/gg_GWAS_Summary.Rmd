...
The function `gg_GWAS_Summary()` creates summary plots showing significant association from your GWAS analyses. 

Specifying a `folder` is all that is needed to create summary GWAS plots.
