...
The function `gg_Manhattan_xModels()` creates manhattan plots from GAPIT GWAS results for multiple traits and facets them by Model. This allows the user to compare the results from different traits across each GWAS model. 
